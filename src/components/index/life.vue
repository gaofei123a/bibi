<template>
  <div class="m-life">
    <el-row>
      <ul class="nav">
        <li>
          <router-link to="/register" class="takeout">美团外卖</router-link>
        </li>
        <li>
          <router-link to="/register">猫眼电影</router-link>
        </li>
        <li>
          <router-link to="/register">美团酒店</router-link>
        </li>
        <li>
          <router-link to="/register" class="apartment">民宿／公寓</router-link>
        </li>
        <li>
          <router-link to="/register" class="business">商家入驻</router-link>
        </li>
        <li>
