...
export default {
  ...
  methods:{
    ...
    //     var regNum = /(\d)+/g;
    //     var reg = /_/g;
    //     var strongth = this.registerForm.password.math(reg) &&
    //     this.registerForm.password.math(regStr) && this.registerForm.password.math(regNum);
    //     if (this.registerForm.password.length > 20 || (this.registerForm.password.length > 6
    //     && strongth)) {
    //         this.strengthClass = 'strong';
    //     } else if(this.registerForm.password.length < 6) {
    //         this.strengthClass = 'week';
